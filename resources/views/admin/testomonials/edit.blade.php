...
@section('content')
<div class="post-page">
	<form method="post" action="<?= route('testomonials.update', $testomonial->slug) ?>" enctype="multipart/form-data">
		{!! csrf_field() !!}
		{!! method_field('PUT') !!}
	  	<div class="form-group <?= $errors->has('title') ? 'has-error' : '' ?>">
		    <label for="title">Title</label>
		    <input type="text" class="form-control" id="title" placeholder="Title" name="title"
		    	value="<?= null !== old('title') ? old('title') : $testomonial->title ?>">
	  	...
	  	<div class="form-group <?= $errors->has('description') ? 'has-error' : '' ?>">
		    ...
		    <textarea id="post-editor" class="post-editor form-control" name="description" rows="10"><?= null !== old('description') ? old('description') : $testomonial->description ?></textarea>
		...
		<div class="form-group <?= $errors->has('name') ? 'has-error' : '' ?>">
		    ...
		    <input type="text" class="form-control" id="upc" placeholder="Name" name="name"
		    	value="<?= null !== old('name') ? old('name') : $testomonial->name ?>">
	  	...
	  	<div class="form-group <?= $errors->has('designation') ? 'has-error' : '' ?>">
		    ...
		    <input type="text" class="form-control" id="upc" placeholder="Name" name="designation"
		    	value="<?= null !== old('designation') ? old('designation') : $testomonial->designation ?>">
	  	...
	  	<div class="form-group <?= $errors->has('company') ? 'has-error' : '' ?>">
		    ...
		    <input type="text" class="form-control" id="company" placeholder="Regular Price" name="company"
		    	value="<?= null !== old('company') ? old('company') : $testomonial->company ?>">
	  	...
	  	<div class="form-group <?= $errors->has('company_website') ? 'has-error' : '' ?>">
		    ...
		    <input type="text" class="form-control" id="company_website" placeholder="Discount Price" name="company_website"
		    	value="<?= null !== old('company_website') ? old('company_website') : $testomonial->company_website ?>">
	  	...
	  	<div class="form-group <?= $errors->has('published_at') ? 'has-error' : '' ?>">
		    ...
		    <input type="text" class="datepicker form-control" name="published_at" value="<?= $testomonial->published_at->format('m/d/Y') ?>">
