								...
								<div class="product-contents"> <strong style="color:#093;"><?= $product->name ?></strong>
									...
									<form action="" method="get" accept-charset="utf-8">
                                      	...
                                      	<select class="form-control">
	                                        ...
	                                        <option>Small (Dogs up to 15lbs 75 Kg Puppy Bites)</option>
	                                        <option>Medium (Dogs up to 30-35lbs)</option>
	                                        <option>Extra Large (Dogs over 50lbs)</option>
	                                    </select> -->
                                       	<div class="product-detail">
                                          	<!-- <span>Net weight 30-35 gm</span>
                                          	<h6>$10.28</h6> -->
                                          	<p>
                                            	<!-- <i>3 (mix with 33 g 033g 033 g)</i><br>
                                            	<i>Wholesale Price: $15.30</i><br> -->
                                            	<i>Discounted Price: $<?= $product->discount_price ?></i><br>
                                            	<i>MSRP: $<?= $product->regular_price ?></i>
                                          	</p>
                                       	</div>
                                   	...
                                   	<!-- <span class="dgs-catogories btn-primary">
                                    	For Dogs  15lbs (7kg puppy bites)
                                  	</span> -->
								</div>
							</div>
						</div>
...
<script>
    ...
    // owl carousel slider //
      $(document).ready(function($) {
        $("#owl-examples").owlCarousel({autoplay: false});
      });

      $(document).on('click', '.owl-next', function() {
        var imageSrc = $('.owl-wrapper-outer .thumb-pic li:first').children('img').attr('src');
